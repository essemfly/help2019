...
model_config = {'measure_dim': len(MEASUREMENT_SOURCE_VALUE_USES), 'con_dim': len(CONDITION_SOURCE_VALUE_USES),
                'embedd_dim': 32, 'drop_prob': 0.1, 'num_heads': 4, 'ffn_dim': 128, 'num_labels': 1, 'num_layers': 1}
...
hyperparams = {'batch_size': 1024, 'lr': 0.001, 'weight_decay': 0.01, 'sampling_strategy': 'front', 'max_seq_len': 512,
               'epochs': 30, 'gamma': 2.0, 'alpha': 0.25, 'prior_prob': 0.059}
