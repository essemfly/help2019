...
def train(cfg):
    ...
    transforms = None
    trainset = AttentionDataset(cfg.get_csv_path(outcome_cohort_csv, mode), max_seq_length=max_seq_length,
    ...
    for epoch in trange(epochs, desc="Epoch"):
        ...
        torch.save(model_to_save, f'{cfg.VOLUME_DIR}/200204_attn_epoch{epoch + 1}_base.ckpt')
